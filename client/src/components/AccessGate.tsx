...
export function AccessGate({ path, isAuthenticated, role, isOwner = false, onLogout, children }: AccessGateProps) {
  if (getErpRouteAccess(path, isAuthenticated, role, isOwner) !== "pending") return <>{children}</>;
